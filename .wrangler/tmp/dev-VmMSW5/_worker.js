...
app2.post("/favorite/:id", async (c) => {
  ...
  try {
    ...
    return c.json({ message: "\u6536\u85CF\u6210\u529F", isfavorites: result.favorites ? result.favorites : 0 });
  } catch (error) {
...
// .wrangler/tmp/bundle-7AQ0C2/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-7AQ0C2/middleware-loader.entry.ts
