...
app3.post("/addHistory", async (c) => {
  ...
  try {
    await db.prepare("INSERT INTO history (userId, articleId, time) VALUES (?, ?, ?)").bind(userId, articleId, viewTime).run();
...
// .wrangler/tmp/bundle-PaGcjk/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-PaGcjk/middleware-loader.entry.ts
