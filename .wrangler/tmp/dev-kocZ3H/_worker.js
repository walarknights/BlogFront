...
app3.get(`/followList/:id`, async (c) => {
  ...
  try {
    ...
    console.log("followList result:", followeeIds);
...
// .wrangler/tmp/bundle-reW4iG/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-reW4iG/middleware-loader.entry.ts
