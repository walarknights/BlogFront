...
app3.post("/upload", async (c) => {
  ...
  try {
    ...
    console.log("B2_KEY_ID:", c.env.B2_KEY_ID);
    console.log("B2_BUCKET_NAME:", c.env.B2_BUCKET_NAME);
...
// .wrangler/tmp/bundle-Ky9FUB/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Ky9FUB/middleware-loader.entry.ts
