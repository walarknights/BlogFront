...
app.post("/login", async (c) => {
  try {
    ...
    const avatar = `https://${c.env.B2_ENDPOINT}/file/${c.env.B2_BUCKET_NAME}` + userInfo.avatar;
...
// .wrangler/tmp/bundle-soDwFL/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-soDwFL/middleware-loader.entry.ts
