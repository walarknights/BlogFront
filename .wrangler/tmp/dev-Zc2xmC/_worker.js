...
app2.get("/comments/:id", async (c) => {
  ...
  try {
    ...
    try {
      ...
      console.error("Generate avatar URL error:", error);
    }
...
// .wrangler/tmp/bundle-Kb8nQj/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Kb8nQj/middleware-loader.entry.ts
