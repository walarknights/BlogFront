...
app2.post("/", async (c) => {
  try {
    ...
    ).bind(userId, content, title, type, abstract, 0, 0, filePath, link).run();
...
// .wrangler/tmp/bundle-B3ytaM/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-B3ytaM/middleware-loader.entry.ts
